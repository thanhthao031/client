...
func NewTeamSigChainPlayerWithState(g *libkb.GlobalContext, helper UsernameFinder, reader keybase1.UserVersion, state TeamSigChainState) *TeamSigChainPlayer {
	res := NewTeamSigChainPlayer(g, helper, reader, state.IsSubteam())
