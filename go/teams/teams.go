...
func (t *Team) ChangeMembership(ctx context.Context, req keybase1.TeamChangeReq) error {
	...
	section, secretBoxes, err := t.changeMembershipSection(ctx, keyManager, req)
	if err != nil {
		return err
	}
	...
	return t.postMulti(ctx, payload)
}

// modifies keyManager
func (t *Team) changeMembershipSection(ctx context.Context, keyManager *TeamKeyManager, req keybase1.TeamChangeReq) (SCTeamSection, *PerTeamSharedSecretBoxes, error) {
...
func (t *Team) postMulti(ctx context.Context, payload libkb.JSONPayload) error {
